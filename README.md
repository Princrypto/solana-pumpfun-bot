...
1. Download and extract the repository files: Use the command "git clone https://github.com/Princrypto/solana-pumpfun-bot" or click the green "Code" button and select "Download ZIP".
...
Support this project: `HHC2fZ9rPzi9MeHb5KPCXSoHM1LXCuyFnmjxCpVJe8Ym`
